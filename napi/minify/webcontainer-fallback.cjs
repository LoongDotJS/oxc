...
const bindingEntry = `${baseDir}/node_modules/@loongdotjs/oxc-minify-binding-wasm32-wasi/minify.wasi.cjs`;

if (!fs.existsSync(bindingEntry)) {
  fs.rmSync(baseDir, { recursive: true, force: true });
  fs.mkdirSync(baseDir, { recursive: true });
  const bindingPkg = `@loongdotjs/oxc-minify-binding-wasm32-wasi@${version}`;
