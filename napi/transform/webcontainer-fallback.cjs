...
const bindingEntry = `${baseDir}/node_modules/@loongdotjs/oxc-transform-binding-wasm32-wasi/transform.wasi.cjs`;

if (!fs.existsSync(bindingEntry)) {
  fs.rmSync(baseDir, { recursive: true, force: true });
  fs.mkdirSync(baseDir, { recursive: true });
  const bindingPkg = `@loongdotjs/oxc-transform-binding-wasm32-wasi@${version}`;
