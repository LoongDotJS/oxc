...
const bindingEntry = `${baseDir}/node_modules/@loongdotjs/oxc-parser-binding-wasm32-wasi/parser.wasi.cjs`;

if (!fs.existsSync(bindingEntry)) {
  fs.rmSync(baseDir, { recursive: true, force: true });
  fs.mkdirSync(baseDir, { recursive: true });
  const bindingPkg = `@loongdotjs/oxc-parser-binding-wasm32-wasi@${version}`;
